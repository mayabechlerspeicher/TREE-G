from treeg_gbdt import GradientBoostedGraphTreeGClassifier, GradientBoostedGraphTreeGRegressor
...
clf = GradientBoostedGraphTreeGClassifier(n_estimators=50, learning_rate=0.1, max_depth=10, random_state=0).fit(X_train, y_train)
